...
Below picture explains the high level workflow of creating and managing AWS Config (managed) Rules in CoreStack,

![](https://github.com/corestacklabs/Policies/blob/qa/workflow/AWS%20Config%20Rule%20-%20Managed.png)
 
<h1> Steps to get a managed AWS Config Rule </h1>

The list of managed AWS Config rules by service are available in the link below,

https://docs.aws.amazon.com/config/latest/developerguide/managed-rules-by-aws-config.html

Difference between managed and custom is that, there will be only parameters.json file for managed, whereas for custom additionally there will be python file for creating lambda function

In the parameters.json file, <b>“SourceIdentifier”</b> will be present for managed AWS Config rules
